...
export default function Home() {
  return (
    <div className="w-[1440px] h-[1024px] relative bg-white">
      ...
      <div className="w-56 h-56 left-[608px] top-[161px] absolute">
      ...
      <div className="left-[430px] top-[48px] absolute text-black text-1xl font-normal font-['Gentium Book Basic']">
        Total Spent Across Projects: $0
      </div>
      <div className="left-[837px] top-[48px] absolute text-black text-1xl font-normal font-['Gentium Book Basic']">
        Shopping Cart: $0
      </div>
    </div>
  );
