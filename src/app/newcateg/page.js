...
export default function NewCategory() {
  return (
    <div className="w-[1440px] h-[1879px] relative bg-white">
      ...
      <div className="left-[68px] top-[228px] absolute text-black text-base font-normal font-['Gentium Book Basic']">
        ----------
      </div>
      <div className="w-[1051px] h-[50px] left-[50px] top-[263px] absolute bg-stone-200 border-2 border-black" />
      <Link href="/addcategory"><div className="left-[68px] top-[278px] absolute text-black text-base font-normal font-['Gentium Book Basic']">
        + Add Category
      </div></Link>
    </div>
  );
